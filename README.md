...
role: Data Engineer @ Tata Consultancy Services (Liberty Mutual Insurance)
education: M.Sc. Computer Science, CGPA 9.19 — SRM Institute of Science and Technology
honors: 🥇 Gold Medal, B.Sc. Computer Science, CGPA 9.55
currently_learning: React.js, Cloud Data Platforms
...
<img src="https://img.shields.io/badge/-ETL%20Pipelines-F97316?style=for-the-badge"/>
...
Flask web app using EfficientNet-B0 CNN to detect lung cancer from CT scans, with a visual results dashboard for healthcare screening support.
...
Inventory management app with CRUD operations, real-time updates, and reporting to reduce manual errors.
...
📎 **See the full case studies on my [portfolio →](https://sudharshan-portfolio-delta.vercel.app/)**
...
<br/>
🗄️ MySQL Basics — Great Learning Platform &nbsp;|&nbsp;
☕ Core Java — Besant Technologies &nbsp;|&nbsp;
🛰️ ISRO LULC Mapping Project (ML)
<br/><br/>
